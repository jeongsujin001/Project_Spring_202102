...
<jsp:include page="../inc/top_menu.jsp"/>
    ...
    <!-- 게시판 -->
<article>
<form action='<c:url value="/gallery/update"/>' method="post" enctype="multipart/form-data">
...
<table class="table_normal">
		...
		<tbody>
			...
			<tr>
				<th>제목</th>
				<td colspan="3"><input type="text" name="subject" class="form-control" name="subject" style="width:100%;" value="${gb.subject}"></td>
			</tr>
			<tr>
				<th>첨부파일</th>
				<td colspan="3"><input type="file" name="file">
				<input type="hidden" name="oldfile" value="${gb.file }">${gb.file }
				</td>			
			</tr>
			<tr>
				<th>글쓴이</th>
...
<!-- 				<td><input type="radio"name="map" value="국내"> 국내      <input type="radio" name="map" value="해외" style="margin-left:10px;"> 해외</td> -->
			...
			<tr>
				<td colspan="4" class="tableTBox"><textarea name="content" rows="20"  class="form-control" style="width:100%;">${gb.content }</textarea></td>
			</tr>
			<tr><th>비밀번호</th>
